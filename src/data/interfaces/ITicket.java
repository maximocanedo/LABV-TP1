...
public interface ITicket {
	...
	/**
	 * Función que calcula y actualiza la tarifa de la entrada. Se debe ejecutar
	 * siempre que se altere algún factor que cambie el precio de la entrada.
	 */
	void updateFee();

	/**
	 * Método TOSTRING FINAL. Este es el método que se debe desarrollar en cada
	 * clase que herede de esta. Sugiero que llamen a super.toString(String[]) con
	 * las líneas adicionales que deseen agregar que sean propias de su clase.
	 */
	String toString();
